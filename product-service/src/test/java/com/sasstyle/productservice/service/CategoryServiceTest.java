...
class CategoryServiceTest {
    ...
    void 카테고리_조회_자식까지() {
        given(categoryRepository.findByIdWithChildren(상의.getId())).willReturn(new CategoryResponse(상의));

        CategoryResponse response = categoryService.findByIdWithChildren(상의.getId());
